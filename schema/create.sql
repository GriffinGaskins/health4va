...
DROP TABLE IF EXISTS fake_cte_completer;

CREATE TABLE fake_cte_completer (
	sch_year integer NOT NULL,
    div_num integer NOT NULL,
    sch_num integer NOT NULL,
    race text NOT NULL,
...
COMMENT ON TABLE fake_cte_completer IS 'fake data to show what our app would look like with sufficient data';

ALTER TABLE face_cte_completer OWNER TO health4va;
